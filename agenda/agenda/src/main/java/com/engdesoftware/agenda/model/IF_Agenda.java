...
public interface IF_Agenda {
     ...
     */
    boolean adicionaContato(String uid, IF_Contato contato);
     ...
     */
    IF_Contato getContato(String uid, String telefone);
     ...
     */
    boolean removeContato(String uid, String telefone);

    /**
     * Retorna todos os contatos da agenda.
     * @return Uma coleção com todos os contatos.
     */
    Collection<IF_Contato> getListaAgenda(String uid);
}